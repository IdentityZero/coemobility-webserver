...
class VehicleCategory(admin.ModelAdmin):
    list_display = ['vehicle_category']
admin.site.register(VehiclesVehiclecategory)
...
admin.site.register(VehiclesVehiclerfid, VehicleRFIDColumn)class VehicleCategoryColumn(admin.ModelAdmin):
    list_display = ['vehicle_category']
